...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NPRootViewController *rootViewController = [[NPRootViewController alloc]init];
    
    rootViewController.title = @"dashBoardController";
    
    NPNavigationController *navigationController = [[NPNavigationController alloc]init];
